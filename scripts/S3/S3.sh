#!/bin/bash
## run the first 150 years of S3 (1701-1850)
...
./xmlchange NTASKS_CPL=-100 #2520
./xmlchange NTASKS_LND=-100 # 
./xmlchange NTASKS_ICE=-100 # 
./xmlchange NTASKS_OCN=-100 # 
./xmlchange NTASKS_ROF=-100 #
./xmlchange NTASKS_GLC=-100 #
./xmlchange NTASKS_WAV=-100 #
